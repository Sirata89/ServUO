...
namespace Server.Custom.KoperPets
{
    public static class PetTamingSkillGain
    {
        ...
        private static readonly TimeSpan TamingCooldown = TimeSpan.FromSeconds(20/*MyServerSettings.KoperCooldown()*/); //  Set cooldown time (20 Seconds default)
        ...
        public static void TryTamingGain(BaseCreature petAttacker, Mobile target)
        {
            ...
            double tamingSkill = owner.Skills[SkillName.AnimalTaming].Base;//owner.Skills[SkillName.Taming].Base;
            double gainChance = 0.0;
            double minGain = 0.0, maxGain = 0.0;
            double tamingMultiplier = 1.0;//MyServerSettings.KoperTamingChance();
            ...
            if (Utility.RandomDouble() < gainChance)
            {
                ...
                owner.Skills[SkillName.AnimalTaming].Base += tamingGain;//owner.Skills[SkillName.Taming].Base += tamingGain;
