...
namespace Server.Custom.KoperPets
{
    public static class KoperHerdingGain
    {
        ...
        private static readonly TimeSpan CooldownTime = TimeSpan.FromSeconds(20); // 20-second cooldownMyServerSettings.KoperCooldown()
        ...
        public static void TryGainHerdingSkill(Mobile owner)
        {
            ...
            double minGain;
            double maxGain;
            double herdingMultiplier = 1.0; //MyServerSettings.KoperHerdingChance();
            ...
            if (Utility.RandomDouble() <= gainChance)
            {
                ...
                if (true/*MyServerSettings.KoperPetsImmersive()*/)
                {
